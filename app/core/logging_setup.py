...
def build_loggers(display_tz, log_dir, action_log_file, system_log_file):
    """Create mcweb action/system log writers and exception logger."""
    ...
    return log_mcweb_action, log_mcweb_log, log_mcweb_exception
